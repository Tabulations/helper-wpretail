...
( function ( global, factory ) {
	...
	var Carousel = /*#__PURE__*/ ( function () {
		...
		_proto._addEventListeners = function _addEventListeners() {
			...
			if ( this._config.keyboard ) {
				$__default
					.default( this._element )
					.on( EVENT_KEYDOWN, function ( event ) {
		...
		_proto._setActiveIndicatorElement = function _setActiveIndicatorElement(
			...
			if ( this._indicatorsElement ) {
				...
				$__default
					.default( indicators )
					.removeClass( CLASS_NAME_ACTIVE$1 );
	...
	$__default
		.default( document )
		.on( EVENT_CLICK_DATA_API$3, SELECTOR_DATA_TOGGLE$1, function (
			event
		) {
	...
	var Modal = /*#__PURE__*/ ( function () {
		...
		_proto.show = function show( relatedTarget ) {
			...
			$__default
				.default( this._element )
				.on( EVENT_CLICK_DISMISS, SELECTOR_DATA_DISMISS, function (
					event
				) {
		...
		_proto._setResizeEvent = function _setResizeEvent() {
			...
			if ( this._isShown ) {
				$__default
					.default( window )
					.on( EVENT_RESIZE, function ( event ) {
	...
	$__default
		.default( document )
		.on( EVENT_CLICK_DATA_API$5, SELECTOR_DATA_TOGGLE$3, function (
			event
		) {
			var _this11 = this;
	...
	var Tooltip = /*#__PURE__*/ ( function () {
		...
		_proto.hide = function hide( callback ) {
			...
			var complete = function complete() {
				if (
					_this2._hoverState !== HOVER_STATE_SHOW &&
					tip.parentNode
				) {
		...
		_proto.setElementContent = function setElementContent(
			...
			if (
				...
				if ( this.config.html ) {
					if (
						! $__default.default( content ).parent().is( $element )
					) {
	...
	$__default
		.default( document )
		.on( EVENT_CLICK_DATA_API$6, SELECTOR_DATA_TOGGLE$4, function (
			event
		) {
			event.preventDefault();
